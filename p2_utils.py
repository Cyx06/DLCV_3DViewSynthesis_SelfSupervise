...
def my_argparse():
	...
	parser.add_argument('--test_img_dir', type = str, default = '../hw4_data/office/val/')
	parser.add_argument('--test_csv_dir', type = str, default = '../hw4_data/office/val.csv')
	parser.add_argument('--result_csv_dir', type = str, default = './prediction.csv')
	...
	parser.add_argument('--trained_checkpoint', type = str, default = 'FinelResNet50.pth')
	parser.add_argument('--test_model_dir', type=str, default='./HW4p2_55acc_model.pth')
